...
//////////////////
/// trying different generation method
//////////////////
...
const product = () => {
  ...
  for (let m = 1; m <= 10; m++) {
    ...
    for (let j = 1; j <= 1000000; j++) {
      // 1 mil records
      data.push(generateFakeProduct());
    }

    // construct csv output stream:
    const outputPath = path.join(__dirname, `../seeds/productData/productData${m}.csv`);
